        ...
        <div className="min-h-screen bg-[#222225] text-white w-full">
          <section className="container mx-auto py-16">
            ...
            <div className="flex gap-4 items-center">
              <Link className="bg-secondary px-3 py-2 rounded-lg" to="/create-post">
                create post
              </Link>
              <Link className="bg-secondary px-3 py-2 rounded-lg" to="/create-news">
                create news
              </Link>
            </div>
            </div>
              ...
              <div className="flex gap-4 mb-8">
                <button
                  ...
                  className={`px-6 py-2 rounded-lg transition-colors ${
                    type === "posts" ? "bg-white text-[#222225]" : "bg-[#2A2A35] text-white hover:bg-[#32323E]"
                  }`}
                >
                  Posts
                </button>
                <button
                  ...
                  className={`px-6 py-2 rounded-lg transition-colors ${
                    type === "news" ? "bg-white text-[#222225]" : "bg-[#2A2A35] text-white hover:bg-[#32323E]"
                  }`}
                >
                  News
                </button>
