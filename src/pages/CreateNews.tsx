...
const CreateNews: FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    try {
      const response = await createNew(form.title, form.content, form.topicId, isMarkdown, image, form.tagIds)
      ...
      <section className="container mx-auto py-16">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="title" className="block text-sm font-medium text-[#f0f0f0]/80">
                Title
              </label>
              <input
                id="title"
            ...
            <div className="space-y-2">
              <label htmlFor="topic" className="block text-sm font-medium text-[#f0f0f0]/80">
                Topic
              </label>
              <select
                id="topic"
              ...
              >
                ...
                {topics.map((topic) => (
                  <option key={topic._id} value={topic._id} className="bg-[#222225]">
                    {topic.title}
                  </option>
                ))}
              </select>
            ...
            <div className="space-y-2">
              <label htmlFor="tags" className="block text-sm font-medium text-[#f0f0f0]/80">
                Tags
              </label>
            ...
            <div className="space-y-2">
              <label htmlFor="content" className="block text-sm font-medium text-[#f0f0f0]/80">
                Content
              </label>
              <div className="relative">
                <textarea
                  ...
                  placeholder={isMarkdown ? "# Your markdown content here..." : "Enter your content here..."}
                />
                {isMarkdown && (
            ...
            {isMarkdown && form.content && (
              <div className="space-y-2">
                <label className="block text-sm font-medium text-[#f0f0f0]/80">Preview</label>
