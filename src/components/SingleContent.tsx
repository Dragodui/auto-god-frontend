...
const SingleContent: React.FC<SingleContentProps> = ({
  ...
  const { currentPost: item, loading } = useSelector((state: RootState) => state.posts);
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex gap-2">
                    {item.tags.map((tag: string) => (
                      <span key={tag} className="bg-[#32323E] px-2 py-1 rounded">
                        {tag}
                      </span>
                    ))}
                  </div>
            ...
            <div className="mt-8 flex items-center gap-4">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                  isLiked() ? "bg-red-500 hover:bg-red-600" : "bg-[#32323E] hover:bg-[#3E3E4A]"
                }`}
              >
